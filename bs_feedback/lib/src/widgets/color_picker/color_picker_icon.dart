...
class ColorPickerIcon extends StatelessWidget {
  ...
  static const _innerColorSize = _iconSize - (_outerRingSize * 2) - (_innerRingSize * 2)
  /*- 1*/;
  ...
  Widget build(BuildContext context) => IconButton(
    ...
    icon: Stack(
      ...
      children: [
        ClipPath(
          clipper: const RingClipper(ringWidth: _outerRingSize),
        ...
        ClipPath(
          clipper: const RingClipper(ringWidth: _innerRingSize),
          child: AnimatedContainer(
            duration: const Duration(milliseconds: 200),
            curve: Curves.decelerate,
  ...
  void _showColorPicker(BuildContext context) => _dismissCallback = BsOverlay.show(
    context: context,
    dismissOnTap: true,
