...
class HrMessages implements LookupMessages {
  ...
  String minutes(int minutes) {
    if (minutes % 100 == 11 || minutes % 100 == 12 || minutes % 100 == 13 || minutes % 100 == 14) {
  ...
  String hours(int hours) {
    if (hours % 100 == 11 || hours % 100 == 12 || hours % 100 == 13 || hours % 100 == 14) {
      return '$hours sati';
    }
  ...
  String months(int months) {
    if (months % 100 == 11 || months % 100 == 12 || months % 100 == 13 || months % 100 == 14) {
