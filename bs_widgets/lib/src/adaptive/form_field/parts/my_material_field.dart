...
class MyMaterialTextFormField extends FormField<String> {
    ...
    List<Locale>? hintLocales,
       ...
       super(
         ...
         builder: (FormFieldState<String> field) {
           ...
           var effectiveDecoration = (decoration ?? const InputDecoration()).applyDefaults(
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  MyMaterialTextFormField get _textFormField => super.widget as MyMaterialTextFormField;
  ...
  @override
  void didUpdateWidget(MyMaterialTextFormField oldWidget) {
