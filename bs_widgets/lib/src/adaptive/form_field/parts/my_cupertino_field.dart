...
/// {@end-tool}
class MyCupertinoTextFormField extends FormField<String> {
  /// Creates a [CupertinoFormRow] containing a [FormField] that wraps
  /// a [CupertinoTextField].
  ///
           ...
           return CupertinoFormRow(
             ...
             child: UnmanagedRestorationScope(
               ...
               child: CupertinoTextField.borderless(
                 ...
                 focusNode: focusNode,
                 padding: contentPadding ?? const EdgeInsets.all(7.0),
                 ...
                 suffix: suffix,
                 // clearButtonMode: showAutoClearButton
  ...
  // /// Should not be used with suffix
...
class _CupertinoTextFormFieldRowState extends FormFieldState<String> {
  ...
  MyCupertinoTextFormField get _cupertinoTextFormFieldRow =>
      super.widget as MyCupertinoTextFormField;
  ...
  @override
  void didUpdateWidget(MyCupertinoTextFormField oldWidget) {
