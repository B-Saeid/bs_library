...
// import '../list_tile/adaptive_list_tile.dart';
//
// /// A crafted Cupertino Popup Item that looks/behave like a tile in a Cupertino Design.
// ///
...
// ///
// /// Typically the [child] of a [CupertinoPopupItem] is a [Text] widget. More
// /// elaborate menus with icons can use a [ListTile]. By default, a
// /// [CupertinoPopupItem] is [kMinInteractiveDimension] pixels high. If you use a widget
...
// /// complete menu, and see the example at [CheckedCupertinoPopupMenuItem] for one way to
// /// keep the text of [CupertinoPopupItem]s that use [Text] widgets in their [child]
// /// slot aligned with the text of [CheckedCupertinoPopupMenuItem]s or of [CupertinoPopupItem]
// /// that use a [ListTile] in their [child] slot.
// ///
// /// See also:
// ///
// ///  * [PopupMenuDivider], which can be used to divide items from each other.
// ///  * [CheckedCupertinoPopupMenuItem], a variant of [CupertinoPopupItem] with a checkmark.
// ///  * [showMenu], a method to dynamically show a popup menu at a given location.
// ///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
// ///    it is tapped.
//
// class CupertinoPopupItem<T> extends PopupMenuEntry<T> {
//   /// Creates an item for a popup menu.
//   ///
//   /// By default, the item is [enabled].
//   const CupertinoPopupItem({
//     super.key,
//     this.value,
//     this.onTap,
//     this.enabled = true,
...
//
//   @override
//   CupertinoPopupItemState<T, CupertinoPopupItem<T>> createState() =>
//       CupertinoPopupItemState<T, CupertinoPopupItem<T>>();
// }
//
// /// The [State] for [CupertinoPopupItem] subclasses.
// ///
// /// By default this implements the basic styling and layout of Material Design
// /// popup menu items.
// ///
// /// The [buildChild] method can be overridden to adjust exactly what gets placed
// /// in the menu. By default it returns [CupertinoPopupItem.child].
// ///
// /// The [handleTap] method can be overridden to adjust exactly what happens when
// /// the item is tapped. By default, it uses [Navigator.pop] to return the
// /// [CupertinoPopupItem.value] from the menu route.
// ///
// /// This class takes two type arguments. The second, `W`, is the exact type of
// /// the [Widget] that is using this [State]. It must be a subclass of
// /// [CupertinoPopupItem]. The first, `T`, must match the type argument of that widget
// /// class, and is the type of values returned from this menu.
// class CupertinoPopupItemState<T, W extends CupertinoPopupItem<T>> extends State<W> {
//   /// The menu item contents.
//   ///
//   /// Used by the [build] method.
//   ///
//   /// By default, this returns [CupertinoPopupItem.child]. Override this to put
...
//   ///
//   /// By default, uses [Navigator.pop] to return the [CupertinoPopupItem.value] from
//   /// the menu route.
//   @protected
//   void handleTap() {
...
//         child: MouseRegion(
//           cursor: _EffectiveMouseCursor(widget.mouseCursor, popupMenuTheme.mouseCursor),
//           child: CupertinoWell(
...
//   /// For example, [CheckedCupertinoPopupMenuItem] overrides this to use
...
// /// shows a popup menu, consider using [PopupMenuButton].
// ///
// /// A [CheckedCupertinoPopupMenuItem] is kMinInteractiveDimension pixels high, which
...
// ///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
// ///    it is tapped.
// class CheckedCupertinoPopupMenuItem<T> extends PopupMenuItem<T> {
//   /// Creates a popup menu item with a checkmark.
//   ///
//   /// By default, the menu item is [enabled] but unchecked. To mark the item as
//   /// checked, set [checked] to true.
//   const CheckedCupertinoPopupMenuItem({
//     super.key,
//     super.value,
//     this.checked = false,
//     super.enabled,
...
//
//   @override
//   PopupMenuItemState<T, CheckedCupertinoPopupMenuItem<T>> createState() =>
//       _CheckedPopupMenuItemState<T>();
// }
//
// class _CheckedPopupMenuItemState<T> extends PopupMenuItemState<T, CheckedCupertinoPopupMenuItem<T>>
...
//           style: effectiveLabelTextStyle?.resolve(states),
...
//             ),
//             title: widget.child ?? const SizedBox.shrink(),
//           ),
//         ),
//       ),
//     );
