...
class _DropsWidgetState extends State<_DropsWidget> with TickerProviderStateMixin {
  ...
  EdgeInsets getPadding() {
    var baseHorizontalPadding = 20.0;
    final baseVerticalPadding = widget.subtitle != null ? 9.0 : 15.0;
  ...
  Widget build(BuildContext context) {
    final iconSize = widget.icon != null ? 24.0 : 0.0;
