...
class DottedLine extends StatelessWidget {
  ...
  /// The color of the dash. Default Divider color.
  ///
        ...
        builder: (context, constraints) {
          ...
          return Wrap(
            ...
            children: List.generate(dashCount + dashGapCount, (index) {
              if (index % 2 == 0) {
                final dashColor = _getDashColor(context, dashCount, index ~/ 2);
  ...
  Color _getDashColor(BuildContext context, int maxDashCount, int index) {
  ...
  Color _calculateGradientColor(
    ...
    var diffAlpha = (endColor.a - startColor.a) * 255;
    var diffRed = (endColor.r - startColor.r) * 255;
    var diffGreen = (endColor.g - startColor.g) * 255;
    var diffBlue = (endColor.b - startColor.b) * 255;
    ...
    return startColor
        .withAlpha(
          (startColor.a * 255).round() + amountOfChangeInAlphaPerItem * index,
        )
        .withRed(
          (startColor.r * 255).round() + amountOfChangeInRedPerItem * index,
        )
        .withGreen(
          (startColor.g * 255).round() + amountOfChangeInGreenPerItem * index,
        )
        .withBlue(
          (startColor.b * 255).round() + amountOfChangeInBluePerItem * index,
        );
  }
}
