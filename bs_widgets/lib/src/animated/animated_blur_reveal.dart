...
class AnimatedBlurReveal extends StatefulWidget {
  const AnimatedBlurReveal({
    super.key,
    required this.child,
    this.duration,
    this.awaitedFuture,
  ...
  @override
  State<AnimatedBlurReveal> createState() => _AnimatedBlurRevealState();
}

class _AnimatedBlurRevealState extends State<AnimatedBlurReveal> with SingleTickerProviderStateMixin {
